...
import { FaFileAlt, FaPlus, FaEdit, FaTrash, FaCalendarAlt } from 'react-icons/fa';
            ...
            <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
                <div className="text-center">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 flex items-center justify-center">
                        <FaFileAlt className="mr-3 text-[#C8050E]" />
                        Отчёты
                    </h1>
                    <p className="text-lg sm:text-xl text-gray-600">Сводка последних отчётов и аналитики</p>
                </div>
                        ...
                        >
                            <div className="space-y-4">
                                <div className="flex items-start justify-between">
                                    <h2 className="text-lg sm:text-xl font-bold text-gray-900">{report.title}</h2>
